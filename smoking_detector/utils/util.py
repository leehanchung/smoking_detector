# https://github.com/leehanchung/fsdl-text-recognizer-project/blob/master/lab9_sln/text_recognizer/util.py
...
def read_image(image_uri: Union[Path, str], grayscale=False) -> np.array:
    ...
    def read_image_from_url(image_url, imread_flag):
        print('util.read_image.read_image_from_url: {}'.format(image_url))
    ...
    try:
        ...
        if local_file:
            ...
            print("util.read_image: READ FROM URL")
